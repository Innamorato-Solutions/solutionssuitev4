<template>
  <div class="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
    ...
    <a class="cursor-pointer block lg:hidden text-700" v-styleclass="{
      selector: '@next',
      enterClass: 'hidden',
      leaveToClass: 'hidden',
    ...
    <div
      ...
      hideOnOutsideClick: true,
          ...
          <ul
            class="list-none p-0 m-0 border-round shadow-0 lg:shadow-2 lg:absolute surface-overlay hidden origin-top w-full lg:w-15rem">
            <li>
              <a v-ripple
                class="flex p-3 align-items-center hover:surface-50 transition-colors transition-duration-150 p-ripple">
      ...
      hideOnOutsideClick: true,
              ...
              <ul
                class="list-none py-3 pl-3 pr-0 m-0 lg:px-0 lg:py-0 border-round shadow-0 lg:shadow-2 lg:absolute surface-overlay hidden origin-top w-full lg:w-15rem cursor-pointer left-100 top-0">
                <li>
                  <a v-ripple
                    class="flex p-3 align-items-center hover:surface-50 transition-colors transition-duration-150 p-ripple">
      ...
      <div
        ...
        <Button label="Login" class="p-button-text font-bold" @click="goTo('login')"></Button>
        <Button label="Register" class="ml-3 p-button-outlined font-bold"></Button>
      </div>
    </div>
  </div>
  <div class="relative p-6 overflow-hidden">
    <img src="" alt="Image" class="absolute top-0 left-0 w-auto h-full block md:w-full" />
  ...
  <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
    ...
    <div class="grid">
      ...
      <div class="col-12 md:col-4 mb-4 px-5">
        ...
        <span class="text-700 line-height-3">Ornare suspendisse sed nisi lacus sed viverra tellus. Neque volutpat
      ...
      <div class="col-12 md:col-4 mb-4 px-5">
        ...
        <span class="text-700 line-height-3">Fermentum et sollicitudin ac orci phasellus egestas tellus rutrum
          tellus.</span>
      </div>
      <div class="col-12 md:col-4 mb-4 px-5">
        <span class="p-3 shadow-2 mb-3 inline-block surface-card" style="border-radius: 10px">
        ...
        <span class="text-700 line-height-3">Nec tincidunt praesent semper feugiat. Sed adipiscing diam donec
  ...
  <div class="surface-section px-4 pb-8 md:px-6 lg:px-8">
    <div class="p-6 shadow-2 flex flex-column md:flex-row align-items-center justify-content-between" style="
        border-radius: 1rem;
      ...
      ">
      <div class="pr-6">
        <div class="text-blue-100 font-medium text-xl mb-3">
          TAKE THE NEXT STEP
        </div>
      ...
      <div class="mt-4 mr-auto md:mt-0 md:mr-0">
        <Button label="Get Started"
          class="font-bold px-5 py-3 p-button-warning p-button-rounded p-button-raised white-space-nowrap"></Button>
      </div>
    </div>
  </div>
  <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
    <div>
      <div class="text-900 font-bold text-4xl line-height-3 mb-3 text-center">
        Continue Breaking Records
      </div>
      <p class="text-600 line-height-3 text-lg m-0 mb-6 text-center">
      ...
      <div class="grid surface-card shadow-2" style="border-radius: 10px">
        ...
        <div class="col-12 md:col-3 px-5 py-5">
          ...
          <div class="text-900 font-bold text-4xl mb-3 line-height-3">
            $256K
          </div>
          <p class="text-700 m-0">
            Nostrum laborum accusamus quia iste facere possimus.
  ...
  <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div>
      ...
      <div class="text-600 mb-6 line-height-3 text-xl text-center">
        We provide many of the Planet Earth’s most powerful companies with
        extraordinary infrastructural capabilities.
      </div>
  ...
  <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
    <div class="font-bold text-5xl text-900 mb-5 text-center">
      Featured Articles
    </div>
    <div class="grid nogutter">
      <div class="col-12 lg:col-4 p-3">
        <div class="shadow-2 border-round h-full surface-card">
          <img src="" alt="Image" class="block w-full border-round-top" />
          <div class="p-4">
  ...
  <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div>
      <div class="text-blue-600 text-2xl mb-4 text-center">
        Save up to 25% today
      </div>
      <div class="text-900 font-bold text-4xl text-center mb-4">
        Pricing Plans
      </div>
      ...
      <div class="flex flex-column md:flex-row mt-6">
        <div class="mb-6 md:mb-0 mr-0 md:mr-4 flex flex-column flex-grow-1">
          ...
          <div class="bg-bluegray-50 p-4 flex flex-column flex-grow-1" style="
              box-shadow: inset 0px 2px 8px rgba(0, 0, 0, 0.1);
              border-radius: 0 0 6px 6px;
            ">
            <div class="text-bluegray-500 font-bold line-height-3 mb-4">
              Ut enim ad minim veniam, quis nostrud exercitation.
            </div>
            <ul class="list-none p-0 m-0 mb-5 text-bluegray-600">
              <li class="flex align-items-center mb-3">
                <i class="pi pi-circle-fill mr-2 text-sm"></i>
            ...
            <Button class="p-button-secondary w-full mt-auto" label="Try Free"></Button>
          </div>
        </div>
        ...
        <div class="mb-6 md:mb-0 mr-0 md:mr-4 flex flex-column flex-grow-1">
          ...
          <div class="bg-bluegray-900 p-4 flex flex-column flex-grow-1 border-3 border-green-500 border-top-none" style="
              box-shadow: inset 0px 2px 8px rgba(0, 0, 0, 0.1);
              border-radius: 0 0 6px 6px;
            ">
            <div class="text-bluegray-400 font-bold line-height-3 mb-4">
            ...
            <Button class="p-button-success w-full mt-auto" label="Buy Now"></Button>
          </div>
        </div>
        ...
        <div class="mb-6 md:mb-0 flex flex-column flex-grow-1">
          ...
          <div class="bg-blue-900 p-4 flex flex-column flex-grow-1" style="
              box-shadow: inset 0px 2px 8px rgba(0, 0, 0, 0.1);
              border-radius: 0 0 6px 6px;
            ">
            <div class="text-blue-400 font-bold line-height-3 mb-4">
            ...
            <Button class="p-button-outlined w-full mt-auto" label="Contact Us"></Button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-nogutter">
      ...
      <div class="col-12 md:col-6">
        <div class="p-fluid formgrid grid px-4 py-8 md:px-6 lg:px-8">
          ...
          <div class="field col-12 mb-4">
            <Textarea id="message" :rows="3" :autoResize="true" class="py-3 px-2 text-lg"
              placeholder="Message"></Textarea>
          </div>
          <div class="col-12 text-right">
            <Button type="button" label="Submit" icon="pi pi-envelope" class="px-5 py-3 w-auto"></Button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gray-900">
      <div class="grid">
        <div class="col-12 md:col-3 flex flex-wrap justify-content-start md:mb-0 mb-3">
          <img src="" alt="footer sections" width="50" height="50" class="mr-3" />
        ...
        <div class="col-12 md:col-3">
          ...
          <div class="text-white mb-3">
            <i class="pi pi-phone surface-800 border-round p-1 mr-2"></i>(31) 20
            779 8986
          </div>
          <div class="text-white mb-3">
            <i class="pi pi-inbox surface-800 border-round p-1 mr-2"></i>hello@bastion.co
          </div>
        </div>
